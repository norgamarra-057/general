...
resource "aws_rds_cluster_instance" "cluster_instances" {
  ...
  #db_parameter_group_name = join("-",["ipg",(var.engine ==  "aurora-mysql" ? "aurora-mysql57" : "aurora56" ),var.size])
  db_parameter_group_name = join("-",["ipg",(var.engine == "aurora-mysql" ? join("",[var.engine,replace(substr(var.engine_version,0,3),".","")]) : "aurora56" ),var.size])
...
resource "aws_rds_cluster" "master" {
  ...
  #db_cluster_parameter_group_name = join("-",["cpg",(var.engine ==  "aurora-mysql" ? "aurora-mysql57" : "aurora56" ),var.size])
  db_cluster_parameter_group_name = join("-",["cpg",(var.engine == "aurora-mysql" ? join("",[var.engine,replace(substr(var.engine_version,0,3),".","")]) : "aurora56" ),var.size])
