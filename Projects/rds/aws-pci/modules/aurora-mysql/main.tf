...
resource "aws_rds_cluster_instance" "cluster_instances" {
  ...
  db_parameter_group_name = join("-",["ipg",(var.engine ==  "aurora-mysql" ? "aurora-mysql80" : "aurora57" ),var.size])
...
resource "aws_rds_cluster" "master" {
  ...
  db_cluster_parameter_group_name = join("-",["cpg",(var.engine ==  "aurora-mysql" ? "aurora-mysql80" : "aurora57" ),var.size])
  db_subnet_group_name            = var.local_subnet_group
