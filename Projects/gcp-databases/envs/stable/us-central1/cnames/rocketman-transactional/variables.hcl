...
db_cname = "rocketman-transactional"
cnames = [
{
db_access_type = "rw"
aws_backend = "pg-noncore-us-516-stg.ccoxqscq6x7v.us-west-1.rds.amazonaws.com."
gcp_backend = "pg-noncore-us-005-stg-rw.gds.stable.gcp.groupondev.com."
aws_weight = 1
gcp_weight = 0
},
{
...
gcp_backend = "pg-noncore-us-005-stg-ro.gds.stable.gcp.groupondev.com."
aws_weight = 1
gcp_weight = 0
}
]
