...
db_cname = "mx-merchant-self-prep"
cnames = [
{
db_access_type = "rw"
aws_backend = "pg-core-emea-581-stg.csgyhkohakjl.us-west-2.rds.amazonaws.com."
gcp_backend = "pg-core-emea-300-stg-rw.gds.stable.gcp.groupondev.com."
aws_weight = 1
gcp_weight = 0
},
{
...
gcp_backend = "pg-core-emea-300-stg-ro.gds.stable.gcp.groupondev.com."
aws_weight = 1
gcp_weight = 0
}
]
