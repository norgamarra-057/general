...
source_server="im-redis-node-slave2.snc1"
source_port="6380"
port1=`echo "30000 + $source_port" | bc`     # 36380   DB0
port2=`echo "40000 + $source_port" | bc`     # 46380   DB2
target_db="users06"
...
ssh $cascade_server "sudo rm -vf /var/groupon/redis/*.rdb"
