# JIRA ticket: RAAS-581
# http://raas-pool11.snc1:8080/notebooks/python_redis_class.ipynb
# 
# Cluster: badges-service-cloud--redis.staging.stable.us-west-1.aws.groupondev.com
# Cluster: consumer-authority-user--redis.staging.stable.us-west-1.aws.groupondev.com
# Standalone: appointments-resque--redis.staging.stable.us-west-1.aws.groupondev.com
...
def query_ip(input_ip):
    response=requests.get("https://raw.github.groupondev.com/data/raas/master/raas_adhoc_scripts/resolve_ip/my_aws_ip_index_dictionary.json")
    readfile=io.StringIO(response.text)
